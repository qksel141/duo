...
export default function Home() {
  ...
  const getCardStyles = (index) => {
    ...
    if (diff === 0) {
      ...
      if (vAnimState === 'zoom') {
        return baseStyles +
          " !duration-200 !scale-[1.06] !shadow-[0_0_80px_rgba(124,58,237,0.6)]";
      }

      if (vAnimState === 'fly-right') {
        return baseStyles +
          " !duration-500 !translate-x-[70vw] !-translate-y-[70vh] !scale-10 !opacity-0 !rotate-12 pointer-events-none";
      }
        ...
        <div className="flex items-center gap-16 relative max-w-6xl w-full justify-center">
          ...
          <button
            ...
            className="
              ...
              flex items-center justify-center text-4xl text-stone-400
          ...
          <div className="flex flex-col gap-6 items-center">
              ...
              {!loading && !error && visibleProfiles.map((profile, index) => (
                <div
                  ...
                  className={`
                    ...
                    bg-stone-900/90 border border-white/10
            ...
            <div className="flex gap-4 w-[400px] h-16 z-40">
              ...
              <button
                ...
                className="
                  flex-1 bg-stone-950/40 hover:bg-stone-900/60
                  backdrop-blur-xl text-white hover:text-red-500
              ...
              <button
                ...
                disabled={isViewingOldCard}
                className="
                  flex-1 bg-violet-600/70 hover:bg-violet-500/90
                  backdrop-blur-xl text-white hover:text-emerald-300
                  transition-all duration-300 flex items-center justify-center
                  text-2xl font-black
                  [clip-path:polygon(0%_0%,85%_0%,100%_50%,85%_100%,0%_100%)]
                  active:scale-95
                  shadow-[0_0_35px_rgba(124,58,237,0.5)]
                  disabled:opacity-30
                "
              >
                ✓
          ...
          <button
            ...
            className="
              ...
              hover:shadow-[0_0_35px_rgba(124,58,237,0.6)]
